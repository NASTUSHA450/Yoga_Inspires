...
function readMore(){
    ...
    for(let i=0;i<moreBtn.length;i++){
        moreBtn[0].addEventListener('click', function(){
            document.getElementById('moreText1').style.display = 'inline';
        ...
        moreBtn[1].addEventListener('click', function(){
            document.getElementById('moreText2').style.display = 'inline';
        ...
        moreBtn[2].addEventListener('click', function(){
            document.getElementById('moreText3').style.display = 'inline';
    ...
    for(let i=0;i<lessBtn.length;i++){
        ...
        lessBtn[2].addEventListener('click', function(){
            document.getElementById('moreText3').style.display = 'none';
